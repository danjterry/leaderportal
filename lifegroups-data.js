...
export const GROUPS = [
  ...
  { id: 'mickey-greg', art: 'assets/groups/mickey-greg.webp', formName: "Greg and Mickey's Lifegroup", leaders: 'Greg & Mickey Taylor', assistants: 'Steve & Kathy Carter', campus: 'Nashville', area: 'Brentwood', time: '6:30pm', kids: false, demographics: ['Adults'], status: 'Open' },
  ...
  { id: 'lisa-diane', art: 'assets/groups/lisa-diane.webp', formName: "Lisa and Diane's Lifegroup", leaders: 'Lisa Walker & Diane Hatchett', assistants: 'Jessica Marse', campus: 'Nashville', area: 'Antioch', time: '7:00pm', kids: false, demographics: ['Young Adults', 'Adults'], status: 'Open' },
  { id: 'michael-michaela', art: 'assets/groups/michael-michaela.webp', formName: "Michael and Michaela's Lifegroup", leaders: 'Michael & Michaela Piper', assistants: 'Kalyn & Alex Nelson', campus: 'Nashville', area: 'Antioch', time: '6:30pm', kids: false, demographics: ['Young Adults'], status: 'Open' },
  { id: 'dylan-tasmin', art: 'assets/groups/dylan-tasmin.webp', formName: "Dylan and Tasmin's Lifegroup", leaders: 'Dylan & Tasmin Hibbert', assistants: '', campus: 'Nashville', area: 'Antioch', time: '7:00pm', kids: true, demographics: ['Young Families'], status: 'Open' },
  { id: 'levi-bryan', art: 'assets/groups/levi-bryan.webp', formName: "Levi and Bryan's Lifegroup", leaders: 'Levi Winnington & Bryan Henkel', assistants: 'Angel Padilla', campus: 'Nashville', area: 'Antioch', time: '6:30pm', kids: false, demographics: ['Young Adults'], status: 'Open' },
  ...
  { id: 'tyler-erica', art: 'assets/groups/tyler-erica.webp', formName: "Tyler and Erica's Lifegroup", leaders: 'Tyler & Erica Thayer', assistants: '', campus: 'Nashville', area: 'Nolensville', time: '6:30pm', kids: true, demographics: ['Adults', 'Families'], status: 'Open' },
  { id: 'jericco-shantelle', art: 'assets/groups/jericco-shantelle.webp', formName: "Jericco and Shantelle's Lifegroup", leaders: 'Jericco & Shantelle Vera', assistants: 'Nikki & Dalton Steele', campus: 'Nashville', area: 'East Nashville', time: '6:30pm', kids: false, demographics: ['Young Adults', 'Young Families'], status: 'Open' },

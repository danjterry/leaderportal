...
export const GROUPS = [
  ...
  { id: 'lisa-diane', art: 'assets/groups/lisa-diane.png', formName: "Lisa and Diane's Lifegroup", leaders: 'Lisa Walker & Diane Hatchett', assistants: 'Jessica Marse', campus: 'Nashville', area: 'Antioch', time: '7:00pm', kids: false, demographics: ['Young Adults', 'Adults'], status: 'Open' },
  { id: 'michael-michaela', art: 'assets/groups/michael-michaela.png', formName: "Michael and Michaela's Lifegroup", leaders: 'Michael & Michaela Piper', assistants: 'Kalyn & Alex Nelson', campus: 'Nashville', area: 'Antioch', time: '6:30pm', kids: false, demographics: ['Young Adults'], status: 'Open' },
  { id: 'dylan-tasmin', art: 'assets/groups/dylan-tasmin.png', formName: "Dylan and Tasmin's Lifegroup", leaders: 'Dylan & Tasmin Hibbert', assistants: '', campus: 'Nashville', area: 'Antioch', time: '7:00pm', kids: true, demographics: ['Young Families'], status: 'Open' },
